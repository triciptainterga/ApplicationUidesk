<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="ReportCSAT.aspx.vb" Inherits="ICC.ReportCSAT" %>
                ...
                <div class="box">
                    ...
                    <div class="box-body p-15">
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="TicketNumber" FieldName="TicketNumber" Width="250px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
