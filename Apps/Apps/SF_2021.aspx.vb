...
Public Class SF_2021
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        tempTrxSLA.SelectCommand = "SELECT * FROM SalesForce_2021 ORDER BY ID ASC"
    End Sub
    ...
    Private Sub btn_Export_Click(sender As Object, e As EventArgs) Handles btn_Export.Click
        ...
        Select Case casses
            Case "xlsx"
                ...
                ASPxGridViewExporter1.WriteXlsxToResponse("SalesForce_2021_" & DateTime.Now.ToString("yyyyMMddhhmmss"))
            Case "xls"
                ASPxGridViewExporter1.WriteXlsToResponse("SalesForce_2021_" & DateTime.Now.ToString("yyyyMMddhhmmss"))
            Case "csv"
                ASPxGridViewExporter1.WriteCsvToResponse("SalesForce_2021_" & DateTime.Now.ToString("yyyyMMddhhmmss"))
        End Select
    End Sub
End Class