                            ...
                            <div class="box-body box-profile">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-lg" type="text" placeholder="Full name" id="TxtName" name="TxtName">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row" style="display:none">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>E-mail</label>
                                            <input class="form-control input-lg" type="text" placeholder="E-mail" id="TxtProfileEmail" name="TxtProfileEmail" title="E-mail">
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="display:none">
                                ...
                                <div class="row" style="display:none">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-lg" type="text" placeholder="NIK number" id="Journey_NIK" name="Journey_NIK" title="NIK number">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-12">
                            <div class="box">
                                        ...
                                        <div class="d-lg-flex d-block justify-content-between align-items-center w-p100">
                                            ...
                                            <div>
                                                <ul class="list-inline mb-0 font-size-18">
                                                    ...
                                                    <!--<li class="list-inline-item" id="newNotaDinas"><a href="#" class="hover-primary" onclick="showNota()">
                                                        <img src="../Images/icon/nota.png" width="24"></a></li>-->
                                                    <li class="list-inline-item" id="newCrm"><a href="#" class="hover-primary" onclick="showCRM()">
                                                        <img src="../Images/icon/crm.png" width="24"></a></li>
                                                </ul>
                                            </div>
                                ...
                                <div class="box-body mb-30" id="ContentTicket">
                                ...
                                <div class="box-footer" id="FooterTicket">
                                    <div class="row">
                                        <div class="col-lg-12">
                                    ...
                                    <br />
                                    <div class="row" id="DivActionJourney">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-3" id="CreateNotaDinas" style="display:none">
                                            <div class="form-group">
                                                ...
                                                <select name="select" id="Journey_Notadinas" required class="form-control" style="height: 33px;" onchange="get_SelectEscalation(1)">
                                ...
                                <div class="box-body mb-30" id="ContentNota" style="display:none">
                                    <div class="panel-body">
                                            ...
                                            <div style="margin-bottom:40px;" id="formInputNota">
                                                <div class="row">
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label>Nomor Nota</label>
                                                  <input type="text" class="form-control" id="NomorNota" placeholder="Nomor Nota" readonly="readonly">
                                                </div>
                                              </div>                                              
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label>Tanggal Nota</label>
                                                  <input type="text" class="form-control" id="TanggalNota" placeholder="Tanggal">
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label>Judul atau Nama Institusi/Perusahaan</label>
                                                  <input type="text" class="form-control" id="JudulNota" placeholder="Judul">
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label>Penerima atau Tujuan Nota</label>
                                                  <input type="text" class="form-control" id="TujuanNota" placeholder="Tujuan Nota">
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label>Perihal Nota</label>
                                                  <input type="text" class="form-control" id="PerihalNota" placeholder="Perihal">
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label>Salinan dan Distribusi</label>
                                                  <select name="select" id="DistribusiNota" class="form-control" style="height: 33px;">
                                                        <option value="">Select</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                                    </select>
                                                ...
                                                <div class="col-md-12">
                                                <div class="form-group">
                                                  <label>Isi atau Pesan</label>
                                                  
                                                  <textarea rows="6" class="form-control" id="IsiPesanNota" name="IsiPesanNota" placeholder="Pesan Nota"></textarea>
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  ...
                                                  <div class="pull-left">
                                                        <div class="btn btn-rounded btn-default btn-file">
                                                            <i class="fa fa-paperclip"></i>&nbsp;Lampiran Nota					 
                                                            <input type="file" name="filesnota">
                                                        </div>
                                                      &nbsp;&nbsp;&nbsp;
                                                      <button type="button" class="btn btn-rounded btn-primary float-right" onclick="submitNotaJourney()" id="SubmitNota">Submit</button>
                                                    </div>
                                           ...
                                           <div style="margin-bottom:40px;" id="formShowNota">
                                                <div class="row">
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label class="text-primary">Nomor Nota</label>
                                                  <p class="font-weight-normal" id="val_NomorNota">Value</p>
                                                </div>
                                              </div>
                                                <div class="col-md-6">    
                                                <div class="form-group">
                                                  <label class="text-primary">Tanggal Nota</label>
                                                  <p class="font-weight-normal" id="val_TanggalNota">Value</p>
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label class="text-primary">Judul atau Nama Institusi/Perusahaan</label>
                                                  <p class="font-weight-normal" id="val_JudulNota">Value</p>
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label class="text-primary">Penerima atau Tujuan Nota</label>
                                                  <p class="font-weight-normal" id="val_TujuanNota">Value</p>
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label class="text-primary">Perihal Nota</label>
                                                  <p class="font-weight-normal" id="val_PerihalNota">Value</p>
                                                </div>
                                              </div>
                                                <div class="col-md-6">
                                                <div class="form-group">
                                                  <label class="text-primary">Salinan dan Distribusi</label>
                                                  <p class="font-weight-normal" id="val_DistribusiNota">Value</p>
                                                </div>
                                              </div>
                                                <div class="col-md-12">
                                                <div class="form-group">
                                                  <label class="text-primary">Isi atau Pesan</label>
                                                  <p class="font-weight-normal" id="val_IsiPesanNota">Value</p>
                                                </div>
                                              </div>
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                  <div class="pull-left">
                                                      <div class="form-group">
                                                        <label class="text-primary"><i class="fa fa-paperclip"></i>&nbsp; Lampiran Nota</label>
                                                        <p class="font-weight-normal" id="val_IsiLampiran">Value</p>
                                                      </div>
                                                      <br>
                                                      <div id="buttonManagerAccess">
                                                         
                                                          
                                                              <div class="form-group">
                                                                  <label>Catatan</label>
                                                  
                                                                  <textarea rows="6" cols="100" class="form-control" id="IsiPesanNotaManager" name="IsiPesanNotaManager" placeholder="Pesan Nota"></textarea>
                                                                </div>
                                                           <button type="button" class="btn btn-rounded btn-success" onclick="SubmitNotaSesuai()">Sesuai</button>
                                                          <button type="button" class="btn btn-rounded btn-warning" onclick="SubmitNotaTidakSesuai()">Tidak Sesuai</button>
                                            ...
                                            <div class="box">
					                        <div class="box-header">
						                        <h4 class="box-title">Nota Dinas Journey</h4>
					                        </div>
					                        <div class="box-body">
                                                <div class="timeline timeline-line-dotted" id="dataHeaderTimelineDiv">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="box">
                                ...
                                <div class="box-body px-0 pt-0" style="height: 1155px; overflow-y: scroll;">
                                    <div class="position-relative p-20">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="display:none">
                                                <div class="form-group">
                                                    <label class="text-primary">Plate number</label>
